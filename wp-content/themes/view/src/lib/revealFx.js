...
;(function(window) {
  ...
  RevealFx.prototype._layout = function() {
    ...
    // Content element.
    this.content = createDOMEl('div', 'block-reveal-content', this.el.innerHTML);
    if( this.options.isContentHidden) {
      this.content.style.opacity = 0;
    }
    // Revealer element (the one that animates)
    this.revealer = createDOMEl('div', 'block-reveal-element');
    this.el.classList.add('block-reveal');
    this.el.innerHTML = '';
