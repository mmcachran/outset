...
namespace Pyxl\WPSettings\Roles\Additions;

use Pyxl\WPSettings\Utils\Role;
...
class Owner
{
    ...
    public function run()
    {
        Role::createRole(self::SLUG, self::NAME, self::CAPABILITIES);
        // Role::updateRoleCaps(self::SLUG, self::CAPABILITIES);
    }
}